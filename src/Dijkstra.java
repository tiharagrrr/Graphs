...
public class Dijkstra {
    ...
    public static Dictionary[] dijkstra(Graph g, Vertex startingVertex) {
        ...
        while (queue.size() != 0) {
            ...
            for (Edge e: current.getEdges()) {
                Integer alternative = distances.get(current.getData()) + e.getWeight(); // distance from starting vertex to current vertex + weight of edge = total weight to edge
    ...
    public static void shortestPathBetween(Graph g, Vertex startingVertex, Vertex targetVertex) {
        ...
        System.out.println("Shortest distance between " + startingVertex.getData() + " and " + targetVertex.getData() + " is: " + distance);
